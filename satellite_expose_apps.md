...
* [MetalLB](#sat-expose-metallb): A `LoadBalancer` implementation suitable for Satellite clusters.
...
1. Verify that the MetalLB Operator is available in the OpenShift Marketplace:
   ```sh
